...
/** Four dots forming a small grid — hub / connections motif. */
export const HubIcon = React.memo(function HubIcon({
  color,
  size,
}: TabIconProps): React.JSX.Element {
  ...
  return (
    <View style={[styles.hubContainer, { width: size, height: size }]}>
      <View style={[styles.hubRow, { marginBottom: gap }]}>
        <View style={dotStyle} />
        <View style={[dotStyle, { marginLeft: gap }]} />
      </View>
